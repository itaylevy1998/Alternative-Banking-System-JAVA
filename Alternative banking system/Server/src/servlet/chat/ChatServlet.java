...
import database.chat.SingleChatEntry;
...
import static userinterface.Constants.CHAT_VERSION_PARAMETER;
...
public class ChatServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
         ...
         */
        int chatVersion = EngineServlet.getIntParameter(request, CHAT_VERSION_PARAMETER);
